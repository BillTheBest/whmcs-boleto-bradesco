...
<html>
	<head>
		...
		<meta name="Generator" content="RatoBoleto um Fork do Boleto PHP em O.O." />
		<style type=text/css>
	...
	<body text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
		...
		<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
			<tr>
    			<td><IMG SRC="<?php echo $dadosboleto["urllogo"]?>"></td>
    			<td class=ti width=455 div align=right>
	   ...
	   <table cellspacing=0 cellpadding=0 width=666 border=0>
		   ...
		   <tbody>
			   <tr><td colspan=5><img height=2 src=imagens/2.png width=666 border=0></td></tr>
		   </tbody>
	   </table>
	   ...
	   <table cellspacing=0 cellpadding=0 width=666 border=0>
		   ...
		   <tbody>
			   ...
			   <tr><td class=ct width=666><img height=1 src=imagens/6.png width=665 border=0></td></tr>
		   </tbody>
	   </table>
	   <br>
	   <table cellspacing=0 cellpadding=0 width=666 border=0>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=666 border=0>
			<TBODY>
				<TR><TD vAlign=bottom align=left height=50><?php echo $dadosboleto["codigo_barras_img"]; ?></TD></tr>
			</tbody>
		</table>
		<TABLE cellSpacing=0 cellPadding=0 width=666 border=0>
			<TR><TD class=ct width=666></TD></TR>
